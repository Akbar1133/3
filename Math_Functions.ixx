...
{
    // Ôóíêöèÿ äëÿ íàõîæäåíèÿ íàèáîëüøåãî îáùåãî äåëèòåëÿ
    ...
    // Ôóíêöèÿ äëÿ íàõîæäåíèÿ íàèìåíüøåãî îáùåãî êðàòíîãî
    int FindLeastCommonMultiple(const int& x, const int& y) {
        // Èñïîëüçóåì ôîðìóëó lcm = |xy| / gcd(x, y)
        return (std::abs(x) * std::abs(y) / FindGreatestCommonDivisor(x, y)) ;
    }
    // Ôóíêöèÿ äëÿ ñîêðàùåíèÿ ðàöèîíàëüíîé äðîáè
    void ReduceFraction(int& numerator, int& denominator) {
        ...
        // Ñîêðàùåíèå ÷èñëèòåëÿ è çíàìåíàòåëÿ
        numerator /= gcd;
        numerator *= sign;
        denominator /= gcd;
